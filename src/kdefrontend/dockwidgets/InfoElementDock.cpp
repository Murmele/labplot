...
void InfoElementDock::connectionLineColorChanged(QColor color) {
	if (m_initializing)
		return;
...
void InfoElementDock::xposLineColorChanged(QColor color) {
	if (m_initializing)
		return;
...
void InfoElementDock::elementLabelBorderShapeChanged(const int gluePointCount) {
	const Lock lock(m_initializing);
